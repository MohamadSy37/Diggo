...
<title>simple social network post - Bootdey.com</title>
...
if($row['type']==="image"){
?>
<img src="img/post/image/<?php echo$row['file'];?>" alt="post-image" class="img-responsive post-image">
<?php
...
<?php 
    if($row_publish['img']===""){
    ?>
<img class="profile-photo-md pull-left" src="img/profile/profile.png" >

<?php
    }else{
        ?>
<img class="profile-photo-md pull-left" src="img/profile/<?php echo$row_publish['img'];?>">
...
if(mysqli_num_rows($checklike)>0){
  ?>
  <div class="reaction">
<a href="php/unlike.php?rn=<?php echo$row['id'];?>" class="btn text-blue"><i class="fa fa-thumbs-up"></i>dislike 
<?php
...
<?php 
    ...
    ?>
<img class="profile-photo-sm" src="img/profile/profile.png" >

<?php
    }else{
        ?>
<img class="profile-photo-sm" src="img/profile/<?php echo$row_user_comment['img'];?>">
...
<?php
if($row_comment['id_user']===$_SESSION['user_id']){
    
    ?>
    
    <form action="php/delete_comment.php" method="post">
   <input type="text" name="id_post" hidden value="<?php echo$_GET['rn'];?>">
   <input type="text" name="id_comment" value="<?php echo$row_comment['id'];?>" hidden>
   <input type="submit" name="delet" class="btn btn-danger" value="Delete" >
    </form>
    <?php }?>
</div>
<?php
}?>
<form action="php/comment.php" method="post" class="post-comment">
<?php 
    if($row_user['img']===""){
    ?>
<img class="profile-photo-sm" src="img/profile/profile.png" >
...
<?php
        ...
        ?>
<img class="profile-photo-sm" src="img/profile/<?php echo$row_user['img'];?>">

        <?php
    }?>
<input type="text" name="comment" class="form-control" placeholder="Post a comment">
<input type="text" name="id" hidden value="<?php echo$_GET['rn'];?>" id="">
